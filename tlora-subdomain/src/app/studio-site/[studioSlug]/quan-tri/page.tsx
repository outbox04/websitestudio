...
export default async function StudioAdminPage({ params }: { params: Promise<{ studioSlug: string }> }) {
  ...
  const [
    ...
    admin
      ...
      .select("id,customer_name,customer_name_slug,shoot_date,raw_drive_folder_url,edited_drive_folder_url,raw_download_enabled,edited_download_enabled,share_token")
  ...
  const editRequests: AdminEditRequest[] = photos
    ...
    .flatMap((photo) => {
      ...
      return gallery
        ? [{
            ...
            customerSlug: gallery.customerSlug,
            shootDate: gallery.shootDate,
            customerUrl: gallery.customerUrl,
            customerDoneUrl: gallery.customerDoneUrl,
