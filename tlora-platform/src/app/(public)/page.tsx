      ...
      <div id="top" className="home-luxury">
        ...
        <section hidden={publishedSections.contact?.isEnabled === false} id="home-final-cta" data-cms-section-root="contact" className="px-5 pb-20 sm:px-8 sm:pb-28 lg:px-10 lg:pb-36">
          <div className="relative mx-auto min-h-[520px] max-w-7xl overflow-hidden rounded-[22px] border border-white/10 px-6 py-16 sm:px-10 lg:flex lg:items-center lg:px-16">
            <Image data-cms-section="contact" data-cms-field="images.finalCta" data-cms-image-url={cmsImage(publishedContact, "finalCta", cmsImage(publishedServices, "service.sinh-nhat", services[0].image))} src={cmsImage(publishedContact, "finalCta", cmsImage(publishedServices, "service.sinh-nhat", services[0].image))} alt="Concept chân dung TLORA" fill sizes="100vw" unoptimized className="object-cover" />
