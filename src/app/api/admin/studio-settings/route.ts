...
export async function PUT(request: Request) {
  ...
  const allowed = ["logo_url", "site_description", "og_image_url", "primary_color", "accent_color", "hero_title", "hero_description", "hero_image_url", "facebook_url", "zalo_phone", "site_content", "seo_keywords", "canonical_url", "facebook_pixel_id", "google_analytics_id", "google_ads_id", "google_tag_manager_id", "tiktok_pixel_id", "custom_head_code", "custom_body_code", "defer_non_critical"];
